...
client: make_gui make_network $(LOCAL_OBJECTS)
	...
	g++ $(CFLAGS) -o twug `pkg-config gtkmm-2.4 gconfmm-2.6 --cflags --libs` network/ClientPool.o network/ClientNetwork.o  network/Network.o network/Data.o network/debug.o network/strip.o network/fill.o gui/MainWindow.o  gui/TrayIcon.o gui/PrefsWindow.o gui/MessageHandler.o gui/MessageWindow.o gui/UIEvents.o gui/UIEventQueueHolder_ToUI.o gui/UIEventQueueHolder_ToNetwork.o gui/ChannelList.o $(LOCAL_OBJECTS)

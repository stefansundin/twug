...
#define SERVER_LOGIN_BAD 1				////string: "1" for bad username "2" for bad password "3" for username already taken
...
#define SERVER_NOTIFY 11				//fill(title) + message_text
#define SERVER_ERROR_NOTIFY 12			//fill(title) + message_text
